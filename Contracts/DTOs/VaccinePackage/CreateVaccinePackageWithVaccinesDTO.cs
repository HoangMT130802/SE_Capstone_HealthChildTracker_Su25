...
{
    public class CreateVaccinePackageWithVaccinesDTO
    {
        ...
        [Required(ErrorMessage = "At least one vaccine is required")]
        [MinLength(1, ErrorMessage = "At least one vaccine is required")]
        public List<CreatePackageVaccineDTO> Vaccines { get; set; }
    }
}
